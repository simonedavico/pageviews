defmodule MarkoPageviewsWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(MarkoPageviewsWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(MarkoPageviewsWeb.Gettext, "errors", msg, opts)
    # end
